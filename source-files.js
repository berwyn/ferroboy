...
sourcesIndex["ferroboy"] = {"name":"","dirs":[{"name":"assembly","files":["disassemble.rs","instruction.rs","instruction_stream.rs","mod.rs"]},{"name":"operations","dirs":[{"name":"add","files":["mod.rs","narrow.rs","wide.rs"]},{"name":"dec","files":["mod.rs","narrow.rs","wide.rs"]},{"name":"inc","files":["mod.rs","narrow.rs","wide.rs"]},{"name":"jump","files":["mod.rs","position.rs","relative.rs"]},{"name":"load","files":["mod.rs","narrow.rs","wide.rs"]},{"name":"rotate","files":["left_carry.rs","mod.rs","right_carry.rs"]}],"files":["and.rs","cp.rs","halt.rs","interrupts.rs","mod.rs","nop.rs","operation.rs","or.rs","pop.rs","push.rs","stop.rs","sub.rs","xor.rs"]},{"name":"system","dirs":[{"name":"register","files":["mod.rs","narrow.rs","wide.rs"]}],"files":["alu.rs","cartridge.rs","config.rs","cpu.rs","mmu.rs","mod.rs","opcodes.rs"]}],"files":["error.rs","helpers.rs","lib.rs","state.rs"]};
